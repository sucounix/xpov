...
docker tag xpovx-dev:latest 086951686584.dkr.ecr.eu-central-1.amazonaws.com/xpovx-dev-falsk-app:latest
...
docker tag nginx:latest 086951686584.dkr.ecr.eu-central-1.amazonaws.com/xpovx-dev-nginx:latest
